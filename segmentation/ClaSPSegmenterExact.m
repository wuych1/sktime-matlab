classdef ClaSPSegmenterExact < handle
    % CLASPSEGMENTEREXACT Exact implementation of ClaSP segmentation
    ...
    methods
        function obj = ClaSPSegmenterExact(varargin)
            % Constructor
            p = inputParser;
            ...
            obj.transformer = ClaSPTransformerExact();
        end
        ...
        function changePoints = fitPredict(obj, timeSeries)
            ...
            if length(timeSeries) < 2 * obj.PeriodLength
                error('ClaSPSegmenterExact:InsufficientData', ...
